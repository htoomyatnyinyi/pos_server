...
// Load .env (optional – your app already does it, but it's safe)
dotenv.config({ path: path.join(__dirname, "../.env") });

// Validate DATABASE_URL is set (the prisma.ts already does this, but we keep it)
...
// import { prisma } from "../src/lib/prisma"; // adjust path if your prisma.ts is elsewhere
// import {
//   Role,
//   AccountType,
//   MovementType,
...
// // Load .env (optional – already loaded by your app, but safe to include)
// dotenv.config({ path: path.join(__dirname, "../.env") });
...
//   // ... (the rest of your seed logic goes here, exactly as you had it)
//   // I won't repeat the full code for brevity – keep all your existing steps unchanged.
...
// // // Create PrismaClient instance with logging (optional)
