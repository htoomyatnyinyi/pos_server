...
// // ၁။ Platform Group (Super Admin အတွက်သာ)
// const platformGroup = (app: Elysia) =>
//   app
//     .use(platformAuthMiddleware) // Super Admin ဟုတ်မဟုတ် စစ်မယ့် Middleware
//     .use(tenantRoutes) // Tenant တွေကို စီမံခန့်ခွဲတဲ့လမ်းကြောင်း
//     .use(auditLogRoutes); // စနစ်တစ်ခုလုံးရဲ့ Log တွေကို ကြည့်ခြင်း

// // ၂။ Tenant Group (ဆိုင်တစ်ဆိုင်ချင်းစီအတွက်)
// const tenantGroup = (app: Elysia) =>
//   app
//     .use(tenantAuthMiddleware) // JWT ကိုစစ်ပြီး tenantId ကို အလိုအလျောက် ထည့်ပေးမယ့် Middleware
//     .use(productRoutes) // ဒီထဲက route တွေအားလုံးမှာ tenantId ပါပြီးသားဖြစ်သွားမယ်
//     .use(orderRoutes)
//     .use(customerRoutes);
...
//   .group("/api", (app) =>
//     app
//       .use(authRoutes) // Login/Register အတွက် (Middleware မလိုပါ)
//       .group("/platform", platformGroup)
